...
export function DeleteTenantUserModal({
  namaUser,
  onCancel,
  onConfirm,
}: {
    ...
    >
      ...
      >
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-red-400">Hapus Pengguna Tenant</h3>
        ...
        <p className="mb-4 text-sm text-[var(--text-secondary)]">
          ...
          <span className="font-medium text-[var(--text-primary)]">{namaUser}</span>
