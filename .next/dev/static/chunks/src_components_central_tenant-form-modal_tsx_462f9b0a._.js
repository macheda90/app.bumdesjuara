...
"[project]/src/components/central/tenant-form-modal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TenantFormModal({ mode, tenant, onClose, onSuccess }) {
    ...
    const [isActive, setIsActive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(tenant?.isActive ?? true);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (mode === 'create') {
                ...
                if (!res.ok) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.error || 'Gagal membuat tenant');
                    return;
                }
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Tenant berhasil dibuat');
            } else if (tenant) {
                const updateData = {
                ...
                const data = await res.json();
                if (!res.ok) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.error || 'Gagal mengupdate tenant');
                    return;
                }
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Tenant berhasil diupdate');
            }
            onSuccess();
        } catch  {
...
_s(TenantFormModal, "sdiq7laLXdknV5pqh04tI4N8wPE=");
_c = TenantFormModal;
var _c;
__turbopack_context__.k.register(_c, "TenantFormModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/central/tenant-form-modal.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/components/central/tenant-form-modal.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=src_components_central_tenant-form-modal_tsx_462f9b0a._.js.map