...
"[project]/src/app/api/tenant/settings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        let settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].tenantSettings.findUnique({
            where: {
        ...
        if (!settings) {
            ...
            settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].tenantSettings.create({
                data: {
                    tenantId: session.tenantId,
...
async function PUT(request) {
    try {
        ...
        if (!settings) {
            ...
            settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].tenantSettings.update({
                where: {
                    tenantId: session.tenantId
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54e27009._.js.map